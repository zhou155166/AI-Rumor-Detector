...
def main():
    # 指定数据文件路径
    data_path = r"F:\大学\大二下\人工智能导论（A类）\大作业\谣言数据集\\"
    ...
    # 保存模型
    model_save_path = r"F:\大学\大二下\人工智能导论（A类）\大作业\我的代码\\"
    torch.save(model.state_dict(), model_save_path + 'bigru_model.pth')
    joblib.dump(vocab, model_save_path + 'vocab.pkl')
    print('模型已保存为bigru_model.pth')
